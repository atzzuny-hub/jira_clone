import { Select, SelectItem, SelectSeparator, SelectTrigger, SelectValue, SelectContent } from "@/components/ui/select";
            ...
            >
                <SelectTrigger className="w-full lg:w-auto h-8">
                    <div className="flex items-center pr-2">
                        ...
                        <SelectValue placeholder="All assingess"/>
                    </div>
                </SelectTrigger>
                <SelectContent className="bg-white">
                    <SelectItem value="al">All assingess</SelectItem>
                    <SelectSeparator/>
